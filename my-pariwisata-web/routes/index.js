...
router.get('/paketwisata', function(req, res, next) {
  let listpaketwisata = [
    { 'nama': 'Eksplorasi Pantai Bali', 'harga': 3500000 },
    { 'nama': 'Heritage Bali', 'harga': 3000000 },
    { 'nama': 'Petualangan Ubud', 'harga': 5000000 },
    { 'nama': 'Kuliner Bali', 'harga': 4000000 },
...
router.post('/orderdetail', function(req, res, next) {
  ...
  const paketHarga = {
    'Paket Eksplorasi Pantai - Bali': 3500000,
    'Paket Heritage Bali - Bali': 3000000,
    'Paket Petualangan Ubud - Bali': 5000000,
    'Paket Kuliner Bali - Bali': 4000000,
